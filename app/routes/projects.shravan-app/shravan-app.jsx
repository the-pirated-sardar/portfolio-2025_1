import backgroundSprLarge from '~/assets/oswald-bg.jpg';
...
import imageSprLessonBuilderDarkLarge from '~/assets/oswald-bg-dark.jpg';
import imageSprLessonBuilderDarkPlaceholder from '~/assets/spr-lesson-builder-dark-placeholder.jpg';
import imageSprLessonBuilderDark from '~/assets/oswald-bg-dark.jpg';
import imageSprLessonBuilderLightLarge from '~/assets/oswald-bg-light.jpg';
import imageSprLessonBuilderLightPlaceholder from '~/assets/spr-lesson-builder-light-placeholder.jpg';
import imageSprLessonBuilderLight from '~/assets/oswald-bg-light.jpg';
...
import styles from './shravan-app.module.css';
...
const title = 'Bettering Web Accessibility';
const description =
  'I worked as a Full Stack and iOS developer at Oswald Labs. My team built using the Oswald Labs Platform, globally recognized for accessible learning.';
const roles = [
  'UX and UI Design',
      ...
      <ProjectContainer>
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
            Oswald Labs identified a significant challenge: many digital platforms 
              are not accessible to individuals with disabilities, such as visual 
              impairments or dyslexia. This inaccessibility limits these users' ability 
              to effectively engage with web content, mobile applications, and other 
              digital services. To address this issue, Oswald Labs developed a suite 
              of tools aimed at enhancing digital accessibility across various platforms. 
              Their offerings include Agastya for websites and apps, Shravan for 
              smartphones, and Valmiki for web browsers, each designed to break barriers 
              and promote universal access. 
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        <ProjectSection light={isDark}>
          <ProjectSectionHeading>More information coming soon...</ProjectSectionHeading>
          {/* <ProjectSectionContent>
            <Image
              key={theme}
              srcSet={
